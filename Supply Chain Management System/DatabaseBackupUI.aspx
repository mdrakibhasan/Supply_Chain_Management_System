<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DatabaseBackupUI.aspx.cs" Inherits="DatabaseBackupUI" %>--%>
 ...
 <%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DatabaseBackupUI.aspx.cs" Inherits="DatabaseBackupUI" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:Label ID="Label50" runat="server" BackColor="#669999" Font-Bold="True" 
        Font-Size="Large" Height="30px" Width="60%" BorderStyle="Inset" ForeColor="White">Database BackUp</asp:Label>
                </td>
            </tr>
            <tr>
                <td style="width:20%;"></td>
