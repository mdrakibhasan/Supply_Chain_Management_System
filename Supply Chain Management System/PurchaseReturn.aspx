<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PurchaseReturn.aspx.cs" Inherits="PurchaseReturn" %>
...
<table id="Table1" style="width:100%;">
	...
	<td style="width: 32%; " align="left">
        <asp:TextBox ID="txtGoodsReceiveNo" runat="server" AutoPostBack="True" placeholder="Search Goods Receive No"
           ...
           ServiceMethod="GetGRN" MinimumPrefixLength="1" CompletionInterval="1000" EnableCaching="true" 
         ...
         <table style="width:100%;"><tr>
           ...
           Text='<%#Eval("qnty")%>' Width="93%" onFocus="this.select()"></asp:TextBox></ItemTemplate>
                         ...
                         <asp:TemplateField HeaderText="ID">
                             ...
                             <FooterStyle HorizontalAlign="Center" />
                             <ItemStyle HorizontalAlign="Right" Width="10%" /></asp:TemplateField>
                            <asp:BoundField DataField="PvQty"  HeaderText="Purchase Oty.">
