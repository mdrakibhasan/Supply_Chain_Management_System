...
<td style="width:100px; vertical-align:middle;" align="left">
<asp:Label ID="lblDesc" runat="server" Font-Size="8pt">User Name</asp:Label>
</td>
<td> <asp:TextBox SkinID="tbGray" ID="txtDesc" Enabled="false" runat="server" Width="362px" Font-Size="8" MaxLength="150"></asp:TextBox></td>
</tr>
<div id="Search" runat="server">
<tr><td colspan="5" style="vertical-align:middle;">
 <fieldset style="vertical-align: top; border: solid 1px #8BB381;text-align:left;line-height:1.5em;"><legend style="color: maroon;"><b>Search User</b></legend>
    <table style="width: 100%">
        <tr>
            ...
            <td style="width: 40%" align="left">
                <asp:TextBox SkinID="tbGray" ID="txtSearch" runat="server" placeholder="Search By User Name OR ID ."
                    Width="362px" Font-Size="8" MaxLength="150" AutoPostBack="True" 
...
<asp:GridView  RowStyle-Height="25px" Font-Names="Tahoma" CssClass="mGrid" 
        ...
        runat="server" AutoGenerateColumns="False" Width="100%" BackColor="White" 
        BorderWidth="1px" BorderStyle="Solid"
        CellPadding="2" BorderColor="LightGray" Font-Size="8pt" PageSize="100" 
        onselectedindexchanged="dgUserMst_SelectedIndexChanged" 
        ForeColor="#333333" onrowdatabound="dgUserMst_RowDataBound"  >
  ...
  <Columns>
  <asp:CommandField ShowSelectButton="True"  ItemStyle-Width="90px" 
          ItemStyle-HorizontalAlign="Center" ItemStyle-ForeColor="Blue" 
          ItemStyle-Height="25px">
<ItemStyle HorizontalAlign="Center" ForeColor="Blue" Height="25px" Width="90px"></ItemStyle>
      </asp:CommandField>
  <asp:BoundField  HeaderText="User ID" DataField="user_name" ItemStyle-Width="120px" 
          ItemStyle-HorizontalAlign="Left">
<ItemStyle HorizontalAlign="Left" Width="120px"></ItemStyle>
      </asp:BoundField>
  <asp:BoundField  HeaderText="User Name" DataField="description" 
          ItemStyle-Width="350px" ItemStyle-HorizontalAlign="Left">
<ItemStyle HorizontalAlign="Left" Width="350px"></ItemStyle>
      </asp:BoundField>
  <asp:BoundField  HeaderText="Group" DataField="user_grp" ItemStyle-Width="150px" 
          ItemStyle-HorizontalAlign="Left">  
<ItemStyle HorizontalAlign="Left" Width="150px"></ItemStyle>
      </asp:BoundField>
      <asp:BoundField HeaderText="GroupID" DataField="usergrp" ItemStyle-Width="150px" ItemStyle-HorizontalAlign="Left">  
<ItemStyle HorizontalAlign="Left" Width="150px"></ItemStyle>
     </asp:BoundField>
  </Columns>
